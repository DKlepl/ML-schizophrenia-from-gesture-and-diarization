...
audio_claps = data.frame(id=character(),
                         diagnosis=numeric(),
                         audio_clap1=numeric(),
                         audio_clap2=numeric(),
                         audio_clap3=numeric())
...
This algorithm works well enough (0.8 accuracy). So now I'll wrap the code from the chunk above into a nice function. Also I'll build a sanity check into the function so that I can prevent any mistakes even before appearing in the final output.
```{r audio algorithm function}

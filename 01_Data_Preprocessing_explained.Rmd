...
claps$diff_1=round(abs(claps$audioclap1-claps$gestclap1),2)
claps$diff_2=round(abs(claps$audioclap2-claps$gestclap2),2)
claps$diff_3=round(abs(claps$audioclap3-claps$gestclap3),2)
...
#and remove silence because it doesn't have any useful information
gesture_final = gesture_final[gesture_final$interviewer!=-1,]

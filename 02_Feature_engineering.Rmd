...
emddim_single = max(par_single$emddim)
emddim_coor = max(par_cor$emddim)

delay_single = max(par_single$delay)
delay_coor = max(par_cor$delay)

final_param_single = data.frame(emddim = max(par_single$emddim),
                                delay = max(par_single$delay),
                                radius = get_mode(par_single$radius))
final_param_cor = data.frame(emddim = max(par_cor$emddim),
                                delay = max(par_cor$delay),
                                radius = get_mode(par_cor$radius))
```

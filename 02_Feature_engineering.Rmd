...
```{r}
par_par = read.csv("clean_data/Split_data/rqa_parameters_participant.csv")
par_int = read.csv("clean_data/Split_data/rqa_parameters_interviewer.csv")
par_cor = read.csv("clean_data/Split_data/rqa_parameters_coordination.csv")
```

...
```{r}
#nzv_c = nearZeroVar(data_c, saveMetrics = T)
...
data_c$set[-inTrain_c] = "test"
data_c$set[inTrain_c] = "train"

data_i$set[-inTrain_i] = "test"
data_i$set[inTrain_i] = "train"

data_p$set[-inTrain_p] = "test"
data_p$set[inTrain_p] = "train"
```

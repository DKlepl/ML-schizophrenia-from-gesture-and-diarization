...
boruta_c = Boruta(diagnosis ~ ., data=data_c[,c(-1, -3 , -58)],maxRuns=200 ,doTrace=2)
boruta_i = Boruta(diagnosis ~ ., data=data_i[,c(-1, -3 , -31)], maxRuns=200 ,doTrace=2)
boruta_p = Boruta(diagnosis ~ ., data=data_p[,c(-1, -3, -31)], maxRuns=200 , doTrace=2)

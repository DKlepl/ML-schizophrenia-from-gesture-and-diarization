...
#save the index - will be useful for meta-model
saveRDS(index_p, "Models/Participant_index.rds")
```
...
saveRDS(index_c, "Models/Coordination_index.rds")
```

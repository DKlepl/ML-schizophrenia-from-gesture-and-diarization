...
expl_log = explain(models$featexp_logistic, y=data[,1], data=data[,-1], predict_function = p_fun, label = "Penalized Logistic Regression")
...
#feature permutation
importance_nn = variable_importance(expl_nn, loss_function = loss_root_mean_square)
importance_bayes = variable_importance(expl_bayes, loss_function = loss_root_mean_square)

plot(importance_bayes)
